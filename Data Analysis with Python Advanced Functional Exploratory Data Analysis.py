...
#############################################
    ...
    pd.set_option('display.max_columns', None)
    pd.set_option('display.width', 500)
    df = pd.read_csv("../Data Science with Python Pandas/datasets/breast_cancer.csv")
    df = df.iloc[:, 1:-1]
    df.head()
    ...
    df = pd.read_csv("../Data Science with Python Pandas/datasets/fraud_train_transaction.csv")
    len(df.columns)
    df.head()
