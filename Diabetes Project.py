...
df = pd.read_csv("feature_engineering/Diabetes/diabetes.csv")
...
##################################
# 1- Take necessary actions for missing and outlier values. There are no missing observations in the data set,
# but Glucose, Insulin etc. Observation units containing a value of 0 in the variables may represent the missing value.
# For example; a person's glucose or insulin value will not be 0. Considering this situation, you can assign the zero
...
##################################
    ...
    # df.loc[(18.5 < df["BMI"]) & (df["BMI"] < 24.9),"NEW_BMI"] = "Healthy"
    # df.loc[(24.9 < df["BMI"]) & (df["BMI"] < 29.9),"NEW_BMI"] = "Overweight"
    # df.loc[(30 < df["BMI"]) ,"NEW_BMI"] = "Obese"
